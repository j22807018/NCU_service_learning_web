...
class NetID
{
    ...
    public function setting($hostdomain, $netidprefix, $allowedRoles)
    {
    ...
    public function doLogin($user = null)
    {
        try {
            ...
            if (!$openid->mode) {
                ...
                // 為了避免 Chrome 的 ERR_RESPONSE_HEADERS_MULTIPLE_LOCATION 錯誤,
                // 我們在 Laravel 中不直接只用 php header(), 因此直接回傳 authUrl() 到 Laravel 的 Controller
                // 讓 redirect 在 Laravel 的 Controller 中完成.
